    ...
    return (
        <span className={cn("inline-flex items-center gap-2", className)}>
            ...
            >
                ...
                <path d="M5.5 17 Q8 14.5 12 14.5 Q16 14.5 18.5 17" stroke="currentColor" strokeWidth="1" strokeLinecap="round" />
                {/* Top notch */}
                <rect x="10" y="3.5" width="4" height="2" rx="0.5" fill="currentColor" />
            </svg>
            {!iconOnly && (
                <span className="text-base font-semibold tracking-tight text-foreground select-none">
                    cassette
                </span>
            )}
        </span>
